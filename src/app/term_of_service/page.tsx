    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12 text-gray-800">
        <h1 className="text-4xl font-bold text-blue-700 mb-6">
          Terms of Service for NIL Edutech (P) Limited
        </h1>
        ...
        <p className="mb-4">
          NIL Edutech (P) Limited shall not be liable for any indirect, incidental, or consequential damages arising from your use of the website.
        </p>
        ...
        <p className="mb-4">
          ...
          <a
            href="mailto:support@nationalinstituteoflanguage.in"
            className="text-blue-600 underline"
          >
            support@nationalinstituteoflanguage.in
          </a>.
        </p>

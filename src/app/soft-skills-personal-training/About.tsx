...
<div>                   
                         ...
                         <img
                            ...
                            />
                        <p className="text-gray-700 text-justify mt-5 ml-5 mr-5">
                          <strong>Soft Skills</strong> training gives benefits for Empowerment, Mastery & Purpose — ability to communicate effectively with co-workers, employers, clients and customers,friends and family members etc.
                        <br/><br/>
                          <strong>National Institute of Language brings well designed & customised Soft Skills Training programs that help to build up the Confidence, Organized, Efficient and Adaptable workforce. Soft skills are the nurturing of your innate personal development. These skills enhance the ability to; Negotiate, Network, Resolve Conflicts and Develop Cohesiveness etc</strong> 
                        <br/><br/>

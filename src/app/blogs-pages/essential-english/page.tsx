...
export default function LanguagePage() {
  ...
  const description = [
    {
      title: "What are Collocations and Why are They Important?",
      content: ["Collocations are combinations of words that frequently occur together in a natural and meaningful way. These word pairs, or even larger groups of words, often have a mutual dependency and cannot be easily separated without losing their meaning or changing the context. For example, we say “strong coffee” but not “powerful coffee”, or “heavy rain” instead of “serious rain”. ",
    ...
    {
      title: "Types of Collocations: Adjective-Noun, Verb-Noun, Preposition-Noun, etc.",
      content: ["English collocations are an important aspect of effective communication and are essential for fluency in the language. These are word combinations that naturally occur and are commonly used by native speakers, making them an integral part of everyday English conversation. Collocations can be broadly classified into different types based on the parts of speech they involve. In this section, we will explore the various types of collocations, such as adjective-noun, verb-noun, preposition-noun, and more."]
    },
    {
  ...
  return (
    <>
      <Navigation />
      <Head>
        <title>Essential English Collocations for Effective Communication</title>
      ...
      <div className="min-h-screen bg-gray-50 mb-16">
        ...
        <section className="relative h-96  flex items-center justify-center text-white overflow-hidden">
          ...
          <div
            ...
            style={{
              backgroundImage: `url(/blog-images/language-skills-reading-listening-speaking-writing-simple-colored-graphic-icons-courses-web-store-language-skills-210916060.webp)`,
            }}
          ></div>
          ...
          <div className="relative z-10 text-center max-w-4xl px-6">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight text-blue-700 ">
              Developing Spoken Proficiency: When to Focus on Fluency vs Accuracy
            </h1>

...
import { FaArrowRight, FaBook, FaBookmark, FaCommentDots,  FaMicrophone, FaPenNib, FaUnderline, FaUserFriends } from "react-icons/fa";
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 items-center">
          ...
          <div className="text-white text-right">
            <h2 className="text-xl md:text-5xl font-semibold leading-tight">
              English communication <br /> programmes for growing <br/>minds
            </h2>
          </div>
        </div>
      </div>
      ...
      <div className="relative bg-white -mt-36 px-6 md:px-16 pb-12">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-start">
          ...
          <div className="text-gray-800 text-sm md:text-base pt-12 md:pt-0 mt-5">
            <p>
              CI offers various programmes for the
              development of communication skills in kids along with personality
              development training. We focus on the overall development while
              imparting the essential skill set.
            </p>
          </div>
...
const LeadershipFlow = () => {
  ...
  <div className="w-full flex flex-col lg:flex-row items-center justify-evenly ">
    ...
    <div className="text-gray-600 text-sm italic text-center lg:text-left w-[250px] h-[100px] lg:w-auto">
      <h3>Potential leaders<br />of the world</h3>
    </div>
    <div><FaArrowRight className="text-4xl  text-gray-400"/></div>

    <div className="bg-lime-400 text-white font-semibold px-8 py-6 text-center text-xl rounded-xl shadow-md w-[450px] h-[150px]  lg:w-auto">
      20+ <br /> Skills
    </div>
 <div><FaArrowRight className="text-4xl  text-gray-400"/></div>
 ...
 <div><FaArrowRight className="text-4xl  text-gray-400"/></div>
    <div className="flex flex-col lg:flex-row items-center gap-2  w-[250px] h-[100px] lg:w-auto">
      ...
      <div className="text-black font-bold text-xl lg:text-2xl leading-tight  text-center">
        Actual<br />Leaders
      </div>
    </div>
  </div>
    ...
    const facts = [
        {
            ...
            description: " Experienced We have the experience and system that proved to be among the best in the world.",
        },
        {
            title: "15 K+",
        ...
        },
        {
            ...
            description: "We not only train students but also train professionals to achieve greater hights.",
        },
    ];
    ...
    return (
        <section className="py-16 px-4 bg-gray-50">
            <div className="max-w-6xl mx-auto">
                    ...
                    {facts.map((fact, index) => (
                        <div key={index} className="text-center">
                            <div className="w-48 h-48 mx-auto  rounded-lg flex flex-col items-center justify-center mb-4 border-2 border-blue-400 ">
                                <div className="text-4xl font-bold mb-2">{fact.title}</div>
                                <div className="text-sm font-medium px-4 text-center leading-tight">{fact.label}</div>
                            </div>
                ...
                <h2 className="text-2xl font-semibold text-center mt-16 mb-8 text-gray-800 max-w-4xl mx-auto">
                    If you have any questions, we encourage you to get in touch with us to discuss your queries in details.
                </h2>
                <div className="text-center">
                    <button className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-3 rounded-lg font-medium hover:bg-blue-700 transition-colors duration-300 shadow-lg">
...
const Pakages = () => {
  ...
  const features = [
    ...
    "Monday-Friday",
    "Weekly Assessments",
    "Sunday Public Speaking"
  ];

  return (
    <div className="bg-white py-12 px-4 sm:px-6 lg:px-8 mb-8 mt-5">
        <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6 text-center">English Communication Packages</h1>
...
const kids_courses = () => {
    return (
        <>
            <div className="w-full px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row">

...
const IndiaFAQs = [
  {
    ...
    answer: "Indian students can apply for government-funded scholarships like the Australia Awards, Endeavour Postgraduate Scholarships, and various university-specific scholarships.",

  },
  {
    question: "Can Indian students get scholarships for undergraduate studies in Australia?",
    answer: "Yes, there are many scholarship in Australia for Indian students which maybe fully funded or partially funded for the students pursuing undergraduate programs.",

  },
  {
    question: "Are there fully funded scholarships for Indian students in Australia?",
    answer: "Yes, there are fully funded scholarships available for Indian students, covering tuition, living expenses, airfare, and health insurance. Some examples include the Australia Awards Scholarships and the Endeavour Scholarships and Fellowships.",
  },
  {
    question:"How can I apply for scholarships to study in Australia?",
    answer:"Students should research available scholarships, check eligibility, prepare required documents, and submit your application online at their respective portals before the deadline.",
  },
   {
    question:"Are there scholarships for master’s degrees in Australia?",
    answer:"Yes, there are several scholarships for master’s degree students, including the Endeavour Postgraduate Scholarship and university-specific options.",
  },
  {
  ...
  },
   {
    ...
    answer:"Yes, many universities in Australia offer partial scholarships that cover a portion of tuition fees for international students.",
  },
  ...
  return (
    <>
      <div className='flex p-5 mb-5 text-blue-900 ml-28'>
        <Link href="#about" >Home</Link><ChevronRight /><Link href="#">Blogs</Link><ChevronRight /><span>Scholarships to Study in Australia for Indian Students</span>
      </div>
      <div className=" bg-white px-4 md:px-10 py-8 ">
        <h1 className="text-3xl md:text-4xl font-semibold -scroll ml-20 mb-6 text-gray-800">
          Scholarships to Study in Australia for Indian Students
        </h1>
        <div className="flex justify-center">
          <img
            src="../swtizerlandstudyvisa/scholarships.webp"
            alt="Visa approval"
            className="rounded-3xl shadow-md w-full max-w-7xl object-cover"
          />
        </div>
      </div>
      <section className="max-w-4xl mx-auto px-4 py-4 space-y-8 text-lg leading-relaxed text-gray-700 text-justify sm:px-6 md:px-10">
        <p>
      ...
      <div className="flex justify-center">
        <img
          src="../swtizerlandstudyvisa/scholarships-to-study-in-australia-for-indian-students.webp"
          alt="Visa approval"
          className="rounded-3xl shadow-md w-200 h-80 max-w-3xl object-cover"
        />
      </div>
      <section className="max-w-4xl mx-auto px-4 py-8">

...
function Syllabus(){
    return(
        ...
        <div id="syllabus" className="px-20" style={{ fontFamily: "'Poppins', sans-serif" }}>
            <h1 className="font-bold text-4xl py-2 ">CELPIP <span className="text-blue-900">Syllabus</span></h1>
            <p className="text-xl">
            <br/>
            <span className="font-bold text-blue-900 py-2">Listening</span>
            <ul className="list-disc list-inside text-gray-700 text-[18px] text-gray-600">
                <li>It has 1 unscored task and 6 scored parts (38 questions). There are 4 conversations and 2 monologues. All audios clips are played once only. All questions are multiple choices, with 4 options and 1 correct answer.</li>
            </ul>
            <br/>
            <span className="font-bold py-2 text-blue-900">Reading</span>
            <br/>
            ...
            <span className="font-bold py-2 text-blue-900">Writing</span>
            <br/>
            <ul className="list-disc text-md list-inside text-[18px] text-gray-600">
                <li>
                    It comprises of 2 tasks. Task 1 presents email prompt. In Task 2, students have to respond to a survey questions.
                </li>
            </ul>

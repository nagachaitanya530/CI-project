           ...
           <section className="bg-cyan-50 shadow-2xl flex flex-col md:flex-row px-4 md:px-10 lg:px-50 py-10">
                ...
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-lg font-bold text-red-600">IELTS</span>
                    ...
                    <h2 className="text-4xl font-bold mb-6">
                        IELTS Complete :International English Language Testing System</h2>
                ...
                <div className="right  bg-white border-gray-300 rounded-xl shadow-lg max-w-md mx-auto hover:bg-gray-100  ">
                    ...
                    <div className="mt-4 m-4">
                        <h2 className="text-xl font-semibold text-gray-800">Complete Preparatory Course</h2>
                        <p className="text-gray-600">Comprehensive English & IELTS Training - Group of 10-15 Students</p>
                    </div>



                    <div className="mt-4 m-4">
                        <h2 className="text-lg font-medium text-gray-800">Beginner Intermediate Level</h2>
                    ...
                    <div className="mt-4 m-4">
                        <h2 className="text-lg font-medium text-gray-800">Upto 2 months / 44 hours</h2>
                    </div>
                </div>
                {/* </div> */}

...
//                 <div className="space-y-6">
//                     {/* Heading */}
//                     <h2 className="text-4xl underline decoration-red-600 font-semibold p-15 text-gray-800">Success Stories</h2>
...
//                                 className="flex transition-transform duration-500 ease-in-out"
//                                 style={{
//                                     transform: translateX(-${(currentIndex * 100) / cardsPerPage}%), // Sliding effect
//                                 }}
//                             >
//                                 {stories.map((story, index) => (
//                                     <div

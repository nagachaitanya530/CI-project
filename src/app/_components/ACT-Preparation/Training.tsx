...
export default function Training() {
  return (
    <section id="training" className="mt-12 px-4 sm:px-6 md:px-10 py-12 md:py-16">
      {/* Heading */}
      ...
      {/* Features List */}
      <ul className="list-disc list-inside text-gray-700 text-base sm:text-lg leading-relaxed space-y-2 mb-6">
        <li>REAL ACT Prep Guide issued as courseware.</li>
        <li>Maximum 10–15 students per batch, making the sessions personalized.</li>
        <li>
          The ACT courses have a strong focus on building fundamental knowledge in Math.
        </li>
        <li>100 hours of intensive and comprehensive training.</li>
        <li>
          Qualified, experienced, and trained faculties for conducting the ACT classes.
        </li>
      ...
      {/* Timing */}
      <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mb-2">Timing:</h3>
      <ul className="list-disc list-inside text-gray-700 text-base sm:text-lg leading-relaxed space-y-1">
        <li>

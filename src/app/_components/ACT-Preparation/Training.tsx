...
export default function Training() {
  return (
    ...
    >
      ...
      {/* Features List */}
      <ul className="list-disc list-inside text-gray-700 text-base sm:text-lg space-y-2 mb-6">
        ...
        <li>
          We conduct both online and offline sessions for the ACT exam training.
        </li>
      </ul>

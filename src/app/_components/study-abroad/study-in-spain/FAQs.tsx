...
const faqs = [
  ...
  {
    question: 'Do I need to have some Spanish language skills to attend a programme?',
    answer:
  ...
  {
    question: 'What are the documents required to study in Spain for Indian students?',
    answer:

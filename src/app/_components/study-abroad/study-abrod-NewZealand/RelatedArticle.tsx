...
function RelatedArticle() {
  return (
    <>
   <div className='flex flex-col items-center mb-10 '  > <h3 className='text-xl sm:text-3xl text-center lg:text-4xl xl:text-5xl	 m-10 '><span className='font-semibold'>Related Articles</span> on Studying in New Zealand</h3>

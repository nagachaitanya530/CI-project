      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-12 items-start">
        ...
        <div className="md:w-1/2 space-y-6">
          ...
          <p className="text-gray-800 text-2xl leading-relaxed">
            The <strong className="font-semibold">Cost Of studying In Singapore</strong> 
           for international students depends on several factors, including the institution, program of study, location, and available funding opportunities. Additionally, living expenses such as rent, utilities, and recreational activities play a significant role in the overall cost.   
          </p>
        </div>
        ...
        <div className="md:w-1/2 space-y-8">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center bg-white rounded-xl px-6 py-4 shadow text-gray-800 font-semibold">
                ...
                <span>SGD 7,000 - 30,000</span>
              </div>
              <div className="flex justify-between items-center bg-white rounded-xl px-6 py-4 shadow text-gray-800 font-semibold">
                <span>Master's</span>
                <span>SGD 25,000 - 55,000</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center bg-white rounded-xl px-6 py-4 shadow text-gray-800 font-semibold">
                <span>On-Campus</span>
                <span>SGD 750 - 2,000</span>
              </div>
              <div className="flex justify-between items-center bg-white rounded-xl px-6 py-4 shadow text-gray-800 font-semibold">
                <span>Off-Campus</span>
                <span>SGD 15,00 - 2,500</span>
              </div>
              <div className="flex justify-between items-center bg-white rounded-xl px-6 py-4 shadow text-gray-800 font-semibold">
                <span>Homestay</span>
                <span>SGD 1,000 - 2,500</span>
              </div>
            </div>
          </div>

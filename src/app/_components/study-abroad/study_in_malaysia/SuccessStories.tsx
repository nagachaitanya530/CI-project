...
const successStories = [
  ...
  },
  {
    ...
    quote:
      "Thanks to Edwise, my study abroad journey was seamless. They guided me every step of the way.",
    image: "https://cdn-icons-png.flaticon.com/512/847/847969.png",
  },
  {
    name: "Riya Patel",
  ...
  {
    name: "Kabir Verma",
    university: "University of Auckland, NZ",
    ...
    <section className="bg-[#dce3ef] py-24 px-6 lg:px-28 rounded-t-[60px]">
      ...
      <div className="relative w-full overflow-hidden">
        <div
          ...
          style={{ transform: `translateX(-${currentIndex * 100}%)`, width: `${successStories.length * 100}%` }}
        >

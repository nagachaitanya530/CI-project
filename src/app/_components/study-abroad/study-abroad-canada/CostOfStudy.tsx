                ...
                <section className=" bg-gray p-6 md:p-10 ">
                    <div className="flex flex-col md:flex-row gap-5 ">
                        ...
                        <div className="md:w-2/5 mb-5 px-5  ">
                            <div >
                                <h1 className="text-[28px] md:text-5xl font-bold my-3 leading-snug align-left md:px-5">
                                    Cost Of Studying<br></br> In Canada
                                </h1>
                            </div>
                            <div>
                        ...
                        <div className="md:w-3/5 mx-3 md:mx-0   ">
                            <div className="">
                                ...
                                <div className="bg-white  border-gray rounded-xl p-5 text-lg font-semibold flex flex-col md:flex-row md:justify-between ">
                                    <p className="mb-2 md:mb-0">PG Diploma, Diploma & Certificate Program</p>
                                    <p>CAD 15,000 – 20,000</p>

                                </div>
                                <br></br>
                                <div className="bg-white  border-gray rounded-xl p-5 text-lg font-semibold flex flex-col md:flex-row md:justify-between">
                                    <p className="mb-2 md:mb-0">Bachelor's</p>
                                    <p>CAD 15,000 – 30,000</p>
                            ...
                            <div>
                                <h2 className=" border font-semibold md:w-1/2 rounded-xl px-5 py-4 text-xl text-gray-500 my-6">
                                                Accommodation (Average per month)</h2>
                                <div className="bg-white  border-gray rounded-xl p-5 text-lg font-semibold flex flex-col md:flex-row md:justify-between">
                                ...
                                <div className="bg-white  border-gray rounded-xl p-5 text-lg font-semibold flex flex-col md:flex-row md:justify-between my-5">
                                    <p className="mb-2 md:mb-0">Off-campus rental</p>
                                    <p>CAD 550 – 1,200</p>
                                </div>
                                <div className="bg-white  border-gray rounded-xl p-5 text-lg font-semibold flex flex-col md:flex-row md:justify-between">
                                    <p className="mb-2 md:mb-0">Homestay</p>
                                    <p>CAD 1000 – 1,300 </p>
                                </div>
                            </div>
                        </div>

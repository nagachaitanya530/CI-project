...
{/* main section */ }
<div className="ml-15 p-6 md:flex md:justify-between md:items-start gap-10 max-w-6xl mx-auto">
    {/* left content */}
    <div className="md:w-2/3 mt-10">
        <h1 className="text-4xl md:text-5xl font-lightl mb-6">
            Why <span className="text-black underline decoration-red-500 font-semibold">Study In New Zealand?
            </span>
        </h1>

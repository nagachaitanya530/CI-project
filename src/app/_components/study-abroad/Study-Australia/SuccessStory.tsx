...
const reviews: Review[] = [
    {
      ...
      "I had an amazing experience with Edwise, they were really helpful in choosing the right university for my preferred course.",
        author: {
            name: "Disha Karmakar",
            institution: "The University of Western, AUS",
            avatar: "/popular-courses/disha-karmakar-australia.webp",
        },
        media: {
            type: "video",
            src: "https://youtu.be/ITs1ZBBCd-U",
    ...
    },
    {
      ...
      "My experience with Edwise has been great. My counselor helped me tremendously and was always there to clear my doubts.",
        author: {
            ...
            avatar: "/popular-courses/srikamalesh-rajendraboopathy-australia.webp",
        },
        media: {
            type: "video",
            src: "/dummy-video.mp4",
    ...
    },
    {
        id: 3,
        quote:
      "A detailed and instructive session with their expert advisor. I fully endorse their services!",
        author: {
            name: "Sreehati",
            institution: "Bond University, AUS",
            avatar: "/popular-courses/sreehari-australia.webp",
        },
        media: {
            type: "video",
            src: "/dummy-video.mp4",
                    ...
                    <div className="flex justify-between items-start mb-16">
                        ...
                        <div className="flex gap-4">
                            <button
                                ...
                                className="rounded-full w-14 h-14 bg-white hover:bg-blue-700 shadow-xl border border-gray-200 flex items-center justify-center transition-all duration-300 hover:scale-105"
                            ...
                            <button
                                onClick={goToNext}
                                className="rounded-full w-14 h-14 bg-white hover:bg-blue-700 shadow-xl flex items-center justify-center transition-all duration-300 hover:scale-105"

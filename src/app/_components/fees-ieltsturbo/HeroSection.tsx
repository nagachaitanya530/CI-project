           ...
           <section className="bg-cyan-50 shadow-2xl flex flex-col md:flex-row px-4 md:px-10 lg:px-50 py-10">
                ...
                <div className="right  bg-white border-gray-300 rounded-xl shadow-lg max-w-md mx-auto hover:bg-gray-100  ">
                    ...
                    <div className="mt-4 m-4">
                        <h2 className="text-xl font-semibold text-gray-800">IELTS Crash Course</h2>
                        <p className="text-gray-600">Super-fast IELTS preparation for advanced aspirants. Group of 10-15 Students</p>
                    </div>



                    <div className="mt-4 m-4">
                        <h2 className="text-lg font-medium text-gray-800">Advanced Level</h2>
                    ...
                    <div className="mt-4 m-4">
                        <h2 className="text-lg font-medium text-gray-800">Upto 1 months / 22+22 hours</h2>
                    </div>
                </div>
                {/* </div> */}

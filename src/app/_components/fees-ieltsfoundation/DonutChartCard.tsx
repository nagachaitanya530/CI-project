...
const skills: Skill[] = [ 
  { name: 'Writing Skills', level: 'CEFR C1 Level Proficiency', percentage: 85, color: 'bg-orange-500' },
  { name: 'Grammar Skills', level: 'CEFR C1 Level Proficiency', percentage: 90, color: 'bg-cyan-500' },
  { name: 'Speaking Skills', level: 'CEFR B2 Level Proficiency', percentage: 75, color: 'bg-rose-500' },
  { name: 'Listening Skills', level: 'CEFR C1 Level Proficiency', percentage: 87, color: 'bg-fuchsia-600' },
  { name: 'Comprehension Skills', level: 'CEFR C1 Level Proficiency', percentage: 86, color: 'bg-blue-900' },
];

export default function CEFRProgress() {
  return (
    <section id='outcome' className="min-h-screen bg-white px-4 py-12 flex items-center justify-center">
      <div className="bg-white shadow-xl rounded-xl p-6 sm:p-8 flex flex-col lg:flex-row gap-8 w-full max-w-6xl">
        ...
        <div className="flex justify-center items-center w-full lg:w-64 h-64 relative mx-auto">
          ...
          <div className="absolute text-center">
            <p className="text-sm text-gray-500">IELTS Band Expectations</p>

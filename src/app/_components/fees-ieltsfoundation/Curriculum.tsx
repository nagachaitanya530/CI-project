  ...
  const curriculumData = [
    {
      ...
      description: (
          ...
          <ul className="list-disc pl-10 my-5">
            <li>88 Hours of Live Sessions.</li>
            <li>44 Hours of Audited Practice Sessions</li>
            <li>10 Full Length Mock Tests</li>
            <li>120+ Practice Tests</li>
          </ul>
        </div>
      ),
    },
    {
      week: "Grammar - Correct use of Tenses",
      description: (
        <div>
          <p>It is important to know which tense structure should be used in what circumstances with appropriate grammatical rules. This topic covers all parts of tenses in brief to rectify the grammatical errors that you may commit while writing or speaking.</p>
         
        </div>
      ),
    },
    {
      week: "Grammar - Prepositions",
      description: (
        <div>
          <p>Prepositions are an important part of grammar as they play a key role in expressing the relationship between words and phrases in a sentence. Prepositions are words that typically come before a noun, pronoun, or gerund, and they indicate location, direction, time, manner, and other relationships between the elements of a sentence.</p>
         
        </div>
      ),
    },
    {
      week: "Grammar - Conjunctions & Cohesive Devices",
      description: (
        <div>
          <p>Conjunctions are very important in order to make sentences more complex, which is a necessity for IELTS writing test for coherence and cohesion parameter.</p>

  ...
  return (
    <section id="enroll" className="py-12 bg-cyan-900 text-white text-center mb-10">
      <div className="max-w-3xl mx-auto px-4">
        <h2 className="text-3xl font-semibold mb-4">Start with IELTS Foundation</h2>
        <p className="mb-6">Course fee is  ₹5990 or $71 <br /> You can pay in EMIs with your credit/debt card (if your bank/card supports it)</p>

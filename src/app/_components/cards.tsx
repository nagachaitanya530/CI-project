                        ...
                        <div className="p-8 flex flex-col h-full relative z-10">
                            ...
                            <div >
                                <button
                                    ...
                                    className="inline-flex items-center text-white hover:text-blue-500 hover:underline cursor-pointer transition-all duration-200 font-medium bg-transparent border-none p-0 text-left"
                                >
                                    Learn More... →
                                </button>
                            </div>

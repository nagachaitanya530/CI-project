const HeroSection = () => {
  return (
    <>
      {/* Main Hero Section with Gradient + SVG BG */}
      <section
      ...
      >
        <div className="relative w-full max-w-7xl flex flex-col md:flex-row items-center justify-between z-10">
          {/* Left Text Content */}
          ...
          {/* Right Enroll Card */}
          <div className="bg-gray-800 text-white p-8 w-80 rounded-2xl shadow-2xl mt-10 md:mt-0">
            ...
            <a href="/enrollment">
              <button className="bg-gradient-to-r from-green-500 to-emerald-500 hover:from-orange-500 hover:to-red-500 shadow-lg hover:shadow-2xl transition-all duration-500 ease-in-out transform hover:-translate-y-2 hover:scale-105 text-white font-bold w-full py-4 rounded-xl text-lg font-sans">
                ENROL NOW
              </button>
            </a>
          </div>

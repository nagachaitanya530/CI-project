...
const HeroSection = () => {
  return (
    <>
      ...
      <section
        className="relative flex items-center pt-8 justify-center px-6 md:px-20 overflow-hidden bg-blue-50"
        style={{
      ...
      >
        <div className="relative w-full  max-w-7xl flex flex-col md:flex-row items-center justify-between">
          {/* Left Text Section */}
          <div className="text-white max-w-2xl z-10">
            ...
            <a href="/book-demo">
              <button className="bg-blue-500 hover:from-blue-600 hover:white shadow-lg  transition-all duration-500 ease-in-out transform hover:-translate-y-0.5 hover:scale-105 text-white font-bold px-8 py-4 rounded-xl text-base  backdrop-blur-sm font-sans hover:cursor-pointer">
                BOOK FREE DEMO
              </button>
            </a>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-center items-center relative">
            <img
              src="/foreign-language-hero-section.png"
              alt="Hero"

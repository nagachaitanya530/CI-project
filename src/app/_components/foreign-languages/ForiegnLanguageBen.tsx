      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-16">
          ...
          <div className="flex justify-center mb-12">
            <img
              src="https://media.canva.com/v2/files/uri:ifs%3A%2F%2FM%2F3f8bfa57-ba44-4326-82e6-b7035db65912?csig=AAAAAAAAAAAAAAAAAAAAAG5ea_VPBnWqp1LMtrKP4HVLOVCEL4y5mWAhFgTqH4f9&exp=1750088062&signer=media-rpc&token=AAIAAU0AJDNmOGJmYTU3LWJhNDQtNDMyNi04MmU2LWI3MDM1ZGI2NTkxMgAAAAABl3lglDAA-YaDxcqLVhY7FsMsiP7wDpmY8q9VAkaJMRv1hLon0Q"
        ...
        <div className="space-y-24 relative">
          <div className="relative flex items-center pl-32">
            <div className="absolute -left-20 top-1/2 transform -translate-y-1/2 text-[8rem] font-bold text-gray-400 z-0 pointer-events-none">01</div>
            <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200 w-3/4 relative z-10">
              <h2 className="text-2xl font-bold text-gray-900 mb-3">
                1. Learning a foreign language is a glamorous endeavour.
              </h2>
              <p className="text-gray-600 text-sm leading-relaxed mb-3">
                Hearing someone speak a foreign language, with its warmth and luscious sounds, is like hearing the sound of gold rushing in to embrace you. Speaking a foreign language is highly appealing, and it can enhance your attractiveness, curiosity, and intelligence by giving you an impression of sophistication and sophistication.
              </p>
              <p className="text-gray-600 text-sm leading-relaxed">
                Learn a foreign language, and you might just find yourself fascinated and lured to your exotic prowess by that certain someone. Many people are attracted to more romantic languages such as Spanish, suave French, or expressive Italian.
              </p>
            </div>
          </div>
          <div className="relative flex items-center justify-end pr-32">
            <div className="absolute -right-20 top-1/2 transform -translate-y-1/2 text-[8rem] font-bold text-gray-400 z-0 pointer-events-none">02</div>
            <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200 w-3/4 relative z-10">
              <h2 className="text-2xl font-bold text-gray-900 mb-3">
          ...
          <div className="relative flex items-center pl-32">
            <div className="absolute -left-20 top-1/2 transform -translate-y-1/2 text-[8rem] font-bold text-gray-400 z-0 pointer-events-none">03</div>
            <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200 w-3/4 relative z-10">
              <h2 className="text-2xl font-bold text-gray-900 mb-3">
          ...
          <div className="relative flex items-center justify-end pr-32">
            <div className="absolute -right-20 top-1/2 transform -translate-y-1/2 text-[8rem] font-bold text-gray-400 z-0 pointer-events-none">04</div>
            <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200 w-3/4 relative z-10">
              <h2 className="text-2xl font-bold text-gray-900 mb-3">
                4. Learning a new language stimulates the brain.
              </h2>
              <p className="text-gray-600 text-sm leading-relaxed">
          ...
          <div className="relative flex items-center pl-32">
            <div className="absolute -left-20 top-1/2 transform -translate-y-1/2 text-[8rem] font-bold text-gray-400 z-0 pointer-events-none">05</div>
            <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200 w-3/4 relative z-10">
              <h2 className="text-2xl font-bold text-gray-900 mb-3">
          ...
          <div className="relative flex items-center justify-end pr-32">
            <div className="absolute -right-20 top-1/2 transform -translate-y-1/2 text-[8rem] font-bold text-gray-400 z-0 pointer-events-none">06</div>
            <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200 w-3/4 relative z-10">
              <h2 className="text-2xl font-bold text-gray-900 mb-3">
          ...
          <div className="relative flex items-center pl-32">
            <div className="absolute -left-20 top-1/2 transform -translate-y-1/2 text-[8rem] font-bold text-gray-400 z-0 pointer-events-none">07</div>
            <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200 w-3/4 relative z-10">
              <h2 className="text-2xl font-bold text-gray-900 mb-3">

...
const BenefitsSection = () => {
  return (
    ...
    <section className="flex flex-col px-14 md:flex-row w-full lg:justify-center  mt-8">
      {/* Left Side - Image */}
      <div className=" flex items-center justify-center md:overflow-hidden ">
        {/* Replace this image with your own */}
        <img
          src="/group-of-three-people.jpg"
          alt="Your custom image"
          className="md:w-xl md:h-full rounded-lg"
        />
      </div>

      {/* Right Side - Content */}
      <div className="bg-white w-full md:w-1/2 flex flex-col justify-center px-8 md:px-12 lg:px-14 py-8 md:py-12">

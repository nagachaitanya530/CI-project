  ...
  const Learn = [
    {
      ...
      description:
        "Give your kids a new experience with Our online English Communication Classes with Interpersonal Skills included.",
      image: "/home/kids-english-classes.jpg", // ✅ use /public/ path style
      url: "/Kids_Courses",
    ...
    },
    {
      ...
      description:
        "Learning a Foreign Language brings new opportunities and experiences. It also serves as an additional skill in your resume. Have fun with French, Spanish and German.",
    ...
    },
    {
      ...
      description:
        "It’s a great time for your kids to learn a new language. Science says learning new languages help the brain develop quickly.",
    ...
    <section className="bg-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
        {Learn.map((work, index) => (
          ...
          >
            <div className="relative h-1/2 w-full transition-transform hover:scale-105">
              <img
                src={work.image}
                alt={work.title}
                loading="lazy"

...
function Scholarships() {
    ...
    const Ausis1 = [
        {
            Image: "../Cost-of-Study9-Ausis.webp",
            para: [<>Australia, also lovingly called as the Land Down Under,
                ...
                students <Link href="/study-abroad/Study-Australia" className="text-blue-900  font-bold">studying in Australia</Link> and provide access to world-class education.</>,
            ]
        }
    ]
    const Ausis2 = [
        {
            ...
            list: [
                <>The Australian government offers several fully funded <Link href="/study-abroad/scholarship" className="text-blue-900  font-bold">scholarships fo Indian students</Link>
    ...
    const Ausis3 = [
        {
            ...
            list: [
                <>Many Australian universities provide scholarships to attract international students. For example,
                    ...
                    offers the Global Diversity Scholarship, providing substantial <Link href="/financial-assistance" className="text-blue-900  font-bold">financial assistance</Link>
    ...
    const Ausis4 = [
        {
            ...
            list: [
                ...
                <>English Proficiency: Most scholarships require proof of English language skills, typically through <Link href="/" className="text-blue-900  font-bold"> IELTS</Link> or <Link href="/toefl" className="text-blue-900  font-bold">TOEFL.</Link>
                </>,
    ...
    const Ausis5 = [
        {
            ...
            list:
                <>Australia continues to be an attractive destination for Indian students, thanks to its world-class education system and cultural diversity.
                    ...
                    or master’s degree,
                    there is a scholarship in Australia that can make your<Link href="/study-abroad" className="text-blue-900  font-bold"> study abroad</Link> study abroad journey more accessible and financially manageable.</>
        },
    ]
    ...
    const faq = [
        {
            ...
            answer:
                "Indian students can apply for government-funded scholarships like the Australia Awards, Endeavour Postgraduate Scholarships, and various university-specific scholarships.",
        },
        {
            question: "What is the cost of to study a Master’s degree in the Australia?",
            answer:
                "The Australia master degree fees typically range from AUD 25,000 - 55,000 per year for international students, depending on the program and university.",
        },
        {
            question: "Can Indian students get scholarships for undergraduate studies in Australia?",
            answer:
                "Yes, there are many scholarships in Australia for Indian students which may be fully funded or partially funded for students pursuing undergraduate programs.",
        },
        {
            question: "Are there fully funded scholarships for Indian students in Australia?",
            answer:
                "Yes, there are fully funded scholarships available for Indian students, covering tuition, living expenses, airfare, and health insurance. Some examples include the Australia Awards Scholarships and the Endeavour Scholarships and Fellowships.",
        },
        {
            question: "How can I apply for scholarships to study in Australia?",
            answer:
                "Students should research available scholarships, check eligibility, prepare required documents, and submit their application online at the respective portals before the deadline.",
        },
        {
            question: "Are there scholarships for master’s degrees in Australia?",
            answer:
                "Yes, there are several scholarships for master’s degree students, including the Endeavour Postgraduate Scholarship and university-specific options.",
        },
        {
            question: "Can I apply for scholarships after receiving an admission offer?",
            answer:
                "Some Australian university scholarships require you to have an offer of admission, while others can be applied for before or after applying to universities.",
        },
        {
            question: "Do Australian universities offer partial scholarships to study in Australia?",
            answer:
                <>
                    Yes, many <Link href="#" className='text-blue-400'>universities in Australia</Link>  offer partial scholarships that cover a portion of tuition fees for international students.
                </>,
        },
    ];
                        ...
                        Ausis1.map((items, index) => (
                            <div key={index} className='flex flex-col gap-4 px-10 xl:px-20'>
                                {items.Image && <img src={items.Image} alt="Image"
                                    className='rounded-3xl xl:h-[35rem] object-cover '
                                />}
                                {items.para &&
